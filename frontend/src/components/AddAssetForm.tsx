    ...
    try {
      if (isFixedIncome) {
        await onSubmit({
          ...
          quantity: null,
          unit_price: null,
          total_value: { amount: String(parseFloat(totalValue) || 0), currency },
          tax_amount: null,
          date,
          notes: notes || null,
        });
        ...
        await onSubmit({
          ...
          unit_price: { amount: String(parseFloat(unitPrice) || 0), currency },
          total_value: { amount: String(parseFloat(computedTotal) || 0), currency },
          tax_amount: { amount: String(parseFloat(taxAmount) || 0), currency },
          date,
          notes: notes || null,
        });
      }
